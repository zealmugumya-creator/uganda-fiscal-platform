...
const CACHE = 'app-guardpost-v3';
const PRECACHE = ['./', 'assets/platform.js', 'assets/responsive.css', 'assets/app-hooks.js', 'assets/icon-192.png', 'assets/icon-512.png', 'manifest.json'];
